...
export default function LabSubject({ SubjectName, returnGradePoint, examName }) {
    ...
    return (
        <Grid container sx={{borderStyle:'dashed', borderColor:'lightblue'}} marginBottom={1} padding={1}>
            ...
            <Grid xs={12} sx={{marginTop:"-10px" ,marginBottom:"20px"}}>
                <p>Grade: {grade}   </p>
                <p>Grade Point: {gradePoint}</p>
            </Grid>
            {/* <InputSlider examName={"Term Final"} defaultValue={68} maxValue={70} returnValue={setTermFinal}></InputSlider> */}
        </Grid>)
}